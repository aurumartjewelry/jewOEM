...
with st.expander("🛠️ 執模台工", expanded=False):
    ...
    if do_mold:
        ...
        st.markdown(
            f"<div style='background:#fff8e1;border-left:4px solid #D4AF37;padding:8px 14px;border-radius:6px;margin:8px 0'>"
        ...
        st.markdown(
            f"<div style='background:#e8f4f8;border-left:4px solid #4682B4;padding:8px 14px;border-radius:6px;margin:8px 0'>"
